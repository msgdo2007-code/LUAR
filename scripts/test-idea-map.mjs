...
test("Visão Geral reserva largura completa para gráfico e mapa", () => { assert.match(css, /#dashboard \.overview-category-map-grid\{grid-column:1\/-1/); assert.match(css, /grid-template-columns:minmax\(0,1\.55fr\) minmax\(320px,\.75fr\)/); assert.match(css, /#dashboard \.dashboard-idea-map-widget\{display:grid/); assert.match(css, /@media\(max-width:1180px\)\{#dashboard \.overview-category-map-grid\{grid-template-columns:1fr/); });
